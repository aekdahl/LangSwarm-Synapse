...
class FilesystemTool(BaseTool):
    ...
    def __init__(
        ...
        self.BASE_DIR = os.path.abspath(directory) or self.BASE_DIR
        self.identifier = identifier
        self.brief = (
            f"A tool to securely create, read, update, and delete files in {self.BASE_DIR}. "
    ...
    def list_all_files_and_folders(self, base_dir, recursive=True):
        ...
        """
        base_dir = self._validate_path(base_dir)
